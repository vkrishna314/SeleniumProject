...
public class CommonUtlities {
	 ...
	 * @Purpose:This method is used to launch the application with user specified
	 *               url and browser
	...
	public static boolean launchApplication(String browser, String url) {
		...
		try {
			...
			default:
				throw new Exception(
						"Invalid Browser name , must be chrome or ff , but the uer has given value :" + browser);
			}
	...
	public static boolean hover(String elementname, String pagename, WebElement element) {
		boolean status = true;
		try {
			...
			System.out.println("Hovered on Element" + elementname + "Successfully");
	...
	public static boolean sendData(String elementname, String pagename, WebElement element, String data) {
		...
		try {
			System.out
					.println("Attempting to send Data :" + data + "into field" + elementname + "into page" + pagename);
			...
			System.out.println("Error in Sending Data " + data + " into Field " + elementname + "in page " + pagename
					+ e.getMessage());
	...
	public static boolean sendDataByClearing(String elementname, String pageName, WebElement element, String data) {
		...
		try {
			System.out.println(
					"Attempting to send Data by Clearing :" + data + "into field" + elementname + "in Page" + pageName);
			// check if the data is not empty
			...
			System.out.println("Error in Sending Data " + data + " by Clearing into Field " + elementname + "in page "
	...
	public static boolean sendDataByChars(String elementname, String pageName, WebElement element, String data) {
		...
		try {
			System.out.println(
					"Attempting to send Data " + data + "by Clearing fieldname " + elementname + "in page" + pageName);
			// check if the data is not empty
			...
			System.out.println(
					"Error in Sending Data by Char into field " + elementname + "in page " + pageName + e.getMessage());
		}
		return status;
	}
	...
	public static boolean selectDropdownByIndex(String elementname, String pageName, WebElement webElement,
			int indexValue) {
		boolean status = true;
		try {
			System.out.println("Selecting the dropdown  by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "indexValue" + indexValue);
			...
			System.out.println("Dropdown is selected by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "indexValue" + indexValue);
		}
	 ...
	 * @Purpose:This method is used to select the drop down by using the value given
	 *               to the dropdown
	 * @Input Parameter:String elementname,String pageName, WebElement
	...
	public static boolean selectDropdownByValue(String elementname, String pageName, WebElement webElement,
			String value)

	{
		...
		try {
			System.out.println("Selecting the dropdown  by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "Value" + value);
			...
			System.out.println("The dropdown is selected by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "Value" + value);
	 ...
	 * @author Shika
	 */
	public static boolean selectDropdownByVisibleText(String elementname, String pageName, WebElement webElement,
			String visibleText)

	{
		...
		try {
			System.out.println("Selecting the dropdown  by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "VisibleText" + visibleText);
			// Check whether the page Name is not null
			if ((pageName == null)) {
	 ...
	 * @Purpose:This method is used to select the drop down by using the Xpath of
	 *               the dropdown.
	 * @Input Parameter:String Xpath
	 * @Output Parameter:boolean
	 */

	public static boolean selectDropdownByXpath(String elementname, String pageName, WebElement webElement,
			String Xpath) {
		boolean status = true;
		try {
			System.out.println("Selecting the dropdown  by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "Xpath" + Xpath);
			// Check whether the page Name is not null
			if (pageName == null) {
			...
			System.out.println("The dropdown is selected  by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + elementname + "Xpath" + Xpath);
	 ...
	 * @Purpose:This method is used to select the drop down by using the CSSSeletor
	 *               of the dropdown.
	...
	public static boolean selectDropdownByCssselector(String elementname, String pageName, WebElement webElement,
			String CssSelector) {
		boolean status = true;
		try {
			System.out.println("Selecting the dropdown  by pageName" + pageName + "elementname" + elementname
					+ " Webelement " + webElement + "CssSelector" + CssSelector);
			// Check whether the page Name is not null
			if ((pageName == null)) {
...
>>>>>>> Stashed changes
	...
	public static boolean IsElementSelected(String elementname, String pagename, WebElement element) {
		 ...
		 * @Purpose: This method is used to check if element passed by user is selected
		 *           or not
	...
	public static boolean IsElementEnabled(String elementname, String pagename, WebElement element) {
		 ...
		 * @Purpose: This method is used to check user required element is enabled or
		 *           disabled
		 * @InputParameters: element name, pagename, element
		 * @OutputParameter: status
		 * @Author: Raghavendra
	...
	public static boolean isElementColorRed(WebElement element) {
		...
		try {
			if (element != null) {
				System.out.println("passed element attribute is:::" + element.getCssValue("color"));
			}
